...
const api: ParaCodeApi = {
  ...
  analyzePlan: (input) => ipcRenderer.invoke(IPC_CHANNELS.planAnalyze, input),
  updatePlan: (input) => ipcRenderer.invoke(IPC_CHANNELS.planUpdate, input),
  confirmPlan: (input) => ipcRenderer.invoke(IPC_CHANNELS.planConfirm, input),
